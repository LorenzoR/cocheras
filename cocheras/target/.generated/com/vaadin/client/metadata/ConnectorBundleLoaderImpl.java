...
public class ConnectorBundleLoaderImpl extends com.vaadin.client.metadata.ConnectorBundleLoader {
  public void init() {
    addAsyncBlockLoader(new AsyncBundleLoader("__eager", new String[] {"com.vaadin.ui.Image","com.vaadin.ui.GridLayout","com.vaadin.ui.UI","com.vaadin.server.FileDownloader","com.vaadin.ui.ListSelect","com.vaadin.ui.Button","com.vaadin.ui.JavaScript","com.vaadin.ui.NativeSelect","com.vaadin.ui.TreeTable","com.vaadin.ui.InlineDateField","com.vaadin.ui.CustomLayout","com.vaadin.ui.PopupView","com.vaadin.ui.Accordion","com.vaadin.ui.FormLayout","com.vaadin.ui.TabSheet","com.vaadin.ui.OptionGroup","com.vaadin.ui.BrowserFrame","com.vaadin.ui.VerticalLayout","com.vaadin.ui.Upload","com.vaadin.ui.Embedded","com.vaadin.ui.DateField","com.vaadin.ui.TextField","com.vaadin.ui.HorizontalSplitPanel","com.vaadin.ui.HorizontalLayout","com.vaadin.ui.Table","com.vaadin.ui.Tree","com.vaadin.ui.ProgressIndicator","com.vaadin.server.BrowserWindowOpener","com.vaadin.server.AbstractJavaScriptExtension","com.vaadin.ui.Label","com.vaadin.ui.Window","com.vaadin.ui.Panel","com.vaadin.ui.CssLayout","com.vaadin.ui.Audio","com.vaadin.ui.Link","com.vaadin.ui.CustomField","com.vaadin.ui.CustomComponent","com.vaadin.ui.PasswordField","com.vaadin.ui.NativeButton","com.vaadin.ui.Video","com.vaadin.ui.CheckBox","com.vaadin.ui.TextArea","com.vaadin.ui.VerticalSplitPanel","com.vaadin.ui.Form","com.vaadin.ui.TwinColSelect","com.vaadin.ui.ComboBox","com.vaadin.ui.MenuBar","com.vaadin.ui.Slider","com.vaadin.ui.DragAndDropWrapper","com.vaadin.ui.AbsoluteLayout","com.vaadin.ui.Flash","com.vaadin.ui.AbstractJavaScriptComponent",}) {
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load1() {
            ...
            store.setProperties(com.vaadin.shared.ui.textfield.AbstractTextFieldState.class, new String[] {"inputPrompt", "width", "required", "errorMessage", "primaryStyleName", "maxLength", "propertyReadOnly", "registeredEventListeners", "enabled", "id", "tabIndex", "hideErrors", "modified", "styles", "text", "description", "caption", "columns", "immediate", "height", "readOnly", "resources", });
            store.setProperties(com.vaadin.shared.ui.popupview.PopupViewState.class, new String[] {"styles", "id", "registeredEventListeners", "html", "caption", "errorMessage", "resources", "enabled", "immediate", "hideOnMouseOut", "description", "primaryStyleName", "height", "width", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.AbstractMediaState.class, new String[] {"enabled", "width", "registeredEventListeners", "sources", "readOnly", "description", "height", "immediate", "muted", "htmlContentAllowed", "primaryStyleName", "altText", "autoplay", "sourceTypes", "showControls", "styles", "id", "resources", "errorMessage", "caption", });
            store.setProperties(com.vaadin.shared.ui.browserframe.BrowserFrameState.class, new String[] {"registeredEventListeners", "errorMessage", "primaryStyleName", "height", "alternateText", "width", "styles", "readOnly", "id", "immediate", "description", "enabled", "caption", "resources", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.AbstractSplitPanelState.SplitterState.class, new String[] {"locked", "maxPosition", "position", "minPositionUnit", "minPosition", "maxPositionUnit", "positionReversed", "positionUnit", });
            store.setProperties(com.vaadin.shared.ui.datefield.PopupDateFieldState.class, new String[] {"registeredEventListeners", "width", "primaryStyleName", "hideErrors", "id", "propertyReadOnly", "height", "required", "textFieldEnabled", "enabled", "styles", "resources", "errorMessage", "description", "immediate", "caption", "modified", "tabIndex", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.combobox.ComboBoxState.class, new String[] {"id", "readOnly", "caption", "enabled", "styles", "propertyReadOnly", "required", "primaryStyleName", "hideErrors", "errorMessage", "immediate", "height", "width", "description", "resources", "registeredEventListeners", "modified", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.csslayout.CssLayoutState.class, new String[] {"enabled", "primaryStyleName", "childCss", "readOnly", "errorMessage", "width", "caption", "id", "registeredEventListeners", "resources", "styles", "height", "immediate", "description", });
            store.setProperties(java.util.HashMap.class, new String[] {});
            store.setProperties(com.vaadin.shared.ui.button.ButtonState.class, new String[] {"resources", "width", "caption", "tabIndex", "enabled", "immediate", "clickShortcutKeyCode", "styles", "errorMessage", "disableOnClick", "height", "description", "primaryStyleName", "registeredEventListeners", "id", "readOnly", "htmlContentAllowed", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.HorizontalLayoutState.class, new String[] {"description", "immediate", "styles", "errorMessage", "registeredEventListeners", "childData", "enabled", "readOnly", "primaryStyleName", "marginsBitmask", "spacing", "height", "caption", "id", "resources", "width", });
            store.setProperties(com.vaadin.shared.ui.embedded.EmbeddedState.class, new String[] {"styles", "id", "alternateText", "primaryStyleName", "immediate", "caption", "enabled", "errorMessage", "registeredEventListeners", "height", "resources", "description", "width", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.table.TableState.class, new String[] {"required", "readOnly", "caption", "height", "width", "description", "primaryStyleName", "propertyReadOnly", "hideErrors", "id", "modified", "errorMessage", "tabIndex", "resources", "styles", "enabled", "immediate", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.MouseEventDetails.class, new String[] {"ctrlKey", "metaKey", "altKey", "shiftKey", "clientX", "clientY", "type", "button", "relativeY", "relativeX", });
            store.setProperties(com.vaadin.shared.ui.menubar.MenuBarState.class, new String[] {"height", "width", "immediate", "caption", "registeredEventListeners", "resources", "primaryStyleName", "description", "readOnly", "styles", "enabled", "id", "errorMessage", });
            store.setProperties(com.vaadin.shared.ui.link.LinkState.class, new String[] {"height", "id", "primaryStyleName", "caption", "enabled", "readOnly", "immediate", "width", "styles", "errorMessage", "registeredEventListeners", "resources", "description", });
            store.setProperties(com.vaadin.shared.ui.datefield.InlineDateFieldState.class, new String[] {"enabled", "tabIndex", "styles", "immediate", "readOnly", "required", "primaryStyleName", "width", "propertyReadOnly", "hideErrors", "registeredEventListeners", "description", "caption", "errorMessage", "height", "resources", "modified", "id", });
            store.setProperties(com.vaadin.shared.ui.checkbox.CheckBoxState.class, new String[] {"width", "enabled", "registeredEventListeners", "resources", "primaryStyleName", "styles", "checked", "propertyReadOnly", "immediate", "id", "hideErrors", "modified", "tabIndex", "height", "readOnly", "errorMessage", "required", "description", "caption", });
            store.setProperties(com.vaadin.shared.ui.panel.PanelState.class, new String[] {"height", "tabIndex", "immediate", "id", "readOnly", "resources", "errorMessage", "caption", "width", "styles", "scrollLeft", "primaryStyleName", "enabled", "registeredEventListeners", "scrollTop", "description", });
            store.setProperties(com.vaadin.shared.ui.video.VideoState.class, new String[] {"showControls", "immediate", "enabled", "errorMessage", "sourceTypes", "readOnly", "resources", "description", "muted", "height", "styles", "autoplay", "htmlContentAllowed", "sources", "altText", "id", "primaryStyleName", "width", "caption", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.flash.FlashState.class, new String[] {"archive", "standby", "classId", "width", "immediate", "codetype", "caption", "enabled", "embedParams", "height", "description", "primaryStyleName", "alternateText", "registeredEventListeners", "readOnly", "resources", "errorMessage", "codebase", "id", "styles", });
            ...
            store.setProperties(com.vaadin.shared.AbstractComponentState.class, new String[] {"id", "errorMessage", "immediate", "primaryStyleName", "enabled", "height", "width", "styles", "registeredEventListeners", "description", "caption", "resources", "readOnly", });
            ...
            store.setProperties(com.vaadin.shared.ui.image.ImageState.class, new String[] {"primaryStyleName", "styles", "readOnly", "alternateText", "errorMessage", "width", "enabled", "caption", "height", "resources", "description", "id", "registeredEventListeners", "immediate", });
            store.setProperties(com.vaadin.shared.ui.JavaScriptComponentState.class, new String[] {"enabled", "description", "height", "errorMessage", "id", "styles", "resources", "registeredEventListeners", "rpcInterfaces", "primaryStyleName", "caption", "readOnly", "width", "callbackNames", "immediate", });
            store.setProperties(com.vaadin.shared.ui.form.FormState.class, new String[] {"enabled", "modified", "layout", "propertyReadOnly", "tabIndex", "readOnly", "styles", "hideErrors", "registeredEventListeners", "immediate", "primaryStyleName", "resources", "height", "width", "description", "id", "caption", "errorMessage", "required", "footer", });
            store.setProperties(com.vaadin.shared.ui.tree.TreeState.class, new String[] {"description", "styles", "enabled", "hideErrors", "immediate", "height", "primaryStyleName", "readOnly", "required", "resources", "id", "caption", "width", "errorMessage", "tabIndex", "registeredEventListeners", "modified", "propertyReadOnly", });
            store.setProperties(com.vaadin.shared.ui.progressindicator.ProgressIndicatorState.class, new String[] {"id", "state", "height", "enabled", "indeterminate", "propertyReadOnly", "description", "registeredEventListeners", "required", "resources", "readOnly", "primaryStyleName", "immediate", "pollingInterval", "hideErrors", "tabIndex", "errorMessage", "width", "styles", "caption", "modified", });
            store.setProperties(com.vaadin.shared.ui.ui.UIState.class, new String[] {"id", "width", "enabled", "height", "styles", "primaryStyleName", "description", "errorMessage", "resources", "tabIndex", "immediate", "readOnly", "caption", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.ChildComponentData.class, new String[] {"alignment", "row2", "column2", "row1", "column1", });
            store.setProperties(com.vaadin.shared.ui.label.LabelState.class, new String[] {"resources", "width", "immediate", "id", "description", "readOnly", "primaryStyleName", "height", "registeredEventListeners", "text", "caption", "errorMessage", "contentMode", "styles", "enabled", });
            store.setProperties(com.vaadin.shared.AbstractFieldState.class, new String[] {"height", "id", "resources", "tabIndex", "hideErrors", "modified", "enabled", "errorMessage", "immediate", "registeredEventListeners", "caption", "required", "styles", "propertyReadOnly", "description", "primaryStyleName", "width", "readOnly", });
            store.setProperties(com.vaadin.shared.ui.button.NativeButtonState.class, new String[] {"styles", "clickShortcutKeyCode", "caption", "disableOnClick", "width", "resources", "id", "description", "enabled", "primaryStyleName", "tabIndex", "htmlContentAllowed", "readOnly", "height", "immediate", "registeredEventListeners", "errorMessage", });
            load2();
          }
          private void load2() {
            store.setProperties(com.vaadin.shared.ui.window.WindowState.class, new String[] {"id", "errorMessage", "scrollLeft", "enabled", "registeredEventListeners", "resources", "caption", "resizeLazy", "readOnly", "styles", "draggable", "tabIndex", "primaryStyleName", "resizable", "positionY", "centered", "positionX", "description", "modal", "scrollTop", "width", "immediate", "height", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.VerticalLayoutState.class, new String[] {"styles", "height", "errorMessage", "width", "childData", "description", "caption", "immediate", "id", "registeredEventListeners", "spacing", "readOnly", "enabled", "resources", "marginsBitmask", "primaryStyleName", });
            store.setProperties(com.vaadin.shared.ui.customlayout.CustomLayoutState.class, new String[] {"styles", "caption", "width", "templateName", "description", "height", "primaryStyleName", "enabled", "templateContents", "id", "resources", "registeredEventListeners", "immediate", "readOnly", "childLocations", "errorMessage", });
            ...
            store.setProperties(com.vaadin.shared.ui.gridlayout.GridLayoutState.class, new String[] {"immediate", "marginsBitmask", "caption", "resources", "spacing", "enabled", "rows", "width", "errorMessage", "description", "registeredEventListeners", "id", "height", "columns", "primaryStyleName", "readOnly", "styles", "childData", });
            store.setProperties(com.vaadin.shared.ui.slider.SliderState.class, new String[] {"caption", "minValue", "orientation", "enabled", "height", "width", "required", "tabIndex", "styles", "hideErrors", "primaryStyleName", "immediate", "id", "resources", "errorMessage", "description", "maxValue", "resolution", "propertyReadOnly", "readOnly", "registeredEventListeners", "value", "modified", });
            store.setProperties(com.vaadin.shared.ui.BrowserWindowOpenerState.class, new String[] {"parameters", "registeredEventListeners", "readOnly", "errorMessage", "primaryStyleName", "description", "features", "resources", "height", "target", "enabled", "width", "immediate", "uriFragment", "id", "styles", "caption", });
            store.setProperties(com.vaadin.shared.ui.twincolselect.TwinColSelectState.class, new String[] {"immediate", "primaryStyleName", "enabled", "registeredEventListeners", "tabIndex", "propertyReadOnly", "required", "height", "description", "resources", "modified", "width", "styles", "errorMessage", "readOnly", "id", "caption", "hideErrors", });
            store.setProperties(com.vaadin.shared.JavaScriptExtensionState.class, new String[] {"resources", "enabled", "rpcInterfaces", "callbackNames", "registeredEventListeners", });
            store.setProperties(com.vaadin.shared.ui.orderedlayout.AbstractOrderedLayoutState.class, new String[] {"readOnly", "description", "styles", "registeredEventListeners", "enabled", "marginsBitmask", "childData", "caption", "spacing", "primaryStyleName", "errorMessage", "immediate", "width", "id", "height", "resources", });
            store.setProperties(com.vaadin.shared.ui.optiongroup.OptionGroupState.class, new String[] {"enabled", "propertyReadOnly", "errorMessage", "hideErrors", "immediate", "description", "readOnly", "tabIndex", "height", "registeredEventListeners", "modified", "resources", "caption", "id", "required", "primaryStyleName", "styles", "width", });
            store.setProperties(com.vaadin.shared.ui.tabsheet.TabsheetState.class, new String[] {"styles", "enabled", "caption", "errorMessage", "width", "immediate", "readOnly", "resources", "registeredEventListeners", "description", "primaryStyleName", "id", "height", });
            store.setProperties(com.vaadin.shared.ui.textarea.TextAreaState.class, new String[] {"immediate", "readOnly", "propertyReadOnly", "caption", "height", "text", "resources", "hideErrors", "rows", "columns", "modified", "description", "maxLength", "id", "wordwrap", "registeredEventListeners", "enabled", "errorMessage", "primaryStyleName", "width", "styles", "required", "inputPrompt", "tabIndex", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.HorizontalSplitPanelState.class, new String[] {"primaryStyleName", "caption", "enabled", "secondChild", "readOnly", "width", "height", "id", "immediate", "resources", "styles", "firstChild", "splitterState", "registeredEventListeners", "errorMessage", "description", });
            store.setProperties(com.vaadin.shared.ui.treetable.TreeTableState.class, new String[] {"enabled", "description", "id", "registeredEventListeners", "primaryStyleName", "styles", "modified", "immediate", "hideErrors", "height", "tabIndex", "readOnly", "width", "required", "resources", "caption", "errorMessage", "propertyReadOnly", });
            store.setProperties(com.vaadin.shared.ui.splitpanel.VerticalSplitPanelState.class, new String[] {"resources", "height", "readOnly", "caption", "styles", "primaryStyleName", "enabled", "errorMessage", "secondChild", "id", "registeredEventListeners", "width", "splitterState", "firstChild", "immediate", "description", });
            store.setProperties(com.vaadin.shared.ui.absolutelayout.AbsoluteLayoutState.class, new String[] {"styles", "id", "height", "immediate", "primaryStyleName", "errorMessage", "readOnly", "connectorToCssPosition", "enabled", "registeredEventListeners", "description", "resources", "width", "caption", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGradientState.class, new String[] {"bgColor", "resources", "cursorY", "cursorX", "caption", "styles", "immediate", "id", "errorMessage", "registeredEventListeners", "enabled", "primaryStyleName", "height", "width", "description", "readOnly", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerState.class, new String[] {"resources", "primaryStyleName", "immediate", "enabled", "htmlContentAllowed", "readOnly", "height", "id", "styles", "width", "popupVisible", "caption", "color", "errorMessage", "description", "showDefaultCaption", "registeredEventListeners", });
      ...
      protected void load(final com.vaadin.client.metadata.TypeDataStore store) {
        com.google.gwt.core.client.GWT.runAsync(new com.google.gwt.core.client.RunAsyncCallback() {
          ...
          private void load() {
            ...
            store.setProperties(com.vaadin.shared.ui.colorpicker.ColorPickerGridState.class, new String[] {"rowCount", "changedX", "id", "styles", "width", "columnCount", "height", "immediate", "resources", "registeredEventListeners", "changedY", "description", "caption", "primaryStyleName", "errorMessage", "changedColor", "enabled", "readOnly", });
